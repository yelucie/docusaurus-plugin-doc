...
Ceci provient de github contributing.
...
This plugin uses GitHub as its source of truth.

### Branch Organization
Our plugin has one primary branch `main` and we use feature branches with deploy previews to deliver new features with pull requests.
